  ...
  return (
    <section className="pt-24 pb-20 px-6 md:px-12 bg-[#0a0a0a]">
      ...
      >
        ...
        <motion.div 
          className="bg-[#111111] rounded-2xl p-6 md:p-8 shadow-xl border border-gray-800/50"
          variants={itemVariants}
        >
          {/* Language Tabs */}
          ...
          <div className="relative">
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-1 rounded text-gray-400 hover:text-white transition-colors"
              >
                {copied ? (
                  <>
            ...
            {/* Code Content */}
            <motion.div 
              className="bg-[#0a0a0a] rounded-xl p-6 border border-gray-800/30"

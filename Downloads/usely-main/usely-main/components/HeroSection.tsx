...
export default function HeroSection() {
  ...
  return (
    <section className="pt-16 pb-16 px-6 md:px-12 bg-[#0a0a0a] min-h-screen flex items-center relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        >
          ...
          >
            ...
            >
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-blue-500/20 via-cyan-500/20 to-blue-500/20 opacity-0 hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
              ...
              <div className="font-mono text-sm text-gray-300 leading-relaxed">
                ...
                >
                  ...
                  <span className="text-gray-400">:</span>{' '}
                  <span className="text-cyan-400">1500</span>
                  <span className="text-gray-400">,</span>
                </motion.div>

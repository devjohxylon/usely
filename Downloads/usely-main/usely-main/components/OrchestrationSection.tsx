...
export default function OrchestrationSection() {
  ...
  return (
    <section className="min-h-screen py-20 px-6 md:px-12 bg-black relative overflow-hidden flex items-center">
      <div className="w-full max-w-7xl mx-auto">
        ...
        >
          <motion.p 
            className="text-xl md:text-2xl text-white max-w-4xl mx-auto leading-relaxed mb-16"

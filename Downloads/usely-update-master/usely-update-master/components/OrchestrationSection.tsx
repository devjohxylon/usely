  ...
  return (
    ...
    >
      ...
      {isHovered && label && (
        ...
        >
          <div className="bg-black/90 border border-white/20 rounded-lg px-3 py-1.5 text-center">
    ...
    <section className="pt-6 pb-12 px-6 md:px-12 bg-[#0a0a0a] relative overflow-hidden">
      ...
      <div className="w-full max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-gray-400 text-lg md:text-xl max-w-4xl mx-auto leading-relaxed mb-8">
            Our intelligent routing engine analyzes request patterns, model performance, and cost efficiency to automatically 
            direct your AI calls to the optimal provider. Get better responses, lower latency, and reduced costs all while 
            maintaining a single API endpoint.
          </p>
